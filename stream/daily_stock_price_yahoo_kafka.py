...
from YahooFinance.Fetch_yahoo_live import fetch_yahoo_live
...
# =============================================================================
    ...
    def yahoo_live_fetch(self, stockquote):
# =============================================================================
...
# =============================================================================
        ...
        try:
            ...
            response_json = self.yahoo.yahoo_live(str(stockquote))
            self.log.debug("Response:"+response_json)
...
# =============================================================================
        ...
        with concurrent.futures.ThreadPoolExecutor(max_workers=10) as executor:
            for x in executor.map(self.yahoo_live_fetch, stock_scan_list):
                pass
